...
const DclAppBar = styled(AppBar, {
    shouldForwardProp: (prop) => !["isSubmenuOpen", "isMobileOpen"].includes(prop),
})((props) => {
...
export { DclAppBar, LogoLink, AppBarDesktopWrapper, AppBarWrapper, AppBarTabletAndBelowWrapper, AppBarRightWrapper, MenuIcon, MenuIconBar, MenuModal, };
