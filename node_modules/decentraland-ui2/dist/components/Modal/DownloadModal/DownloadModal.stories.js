...
const meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component: "DownloadModal is used to prompt users to download the Decentraland app when they try to jump in without having the launcher installed.",
            },
        },
    },
    argTypes: {
...
const CustomContent = {
    ...
    render: (args) => {
        return _jsx(DownloadModal, { ...args });
    },
};
const WithActions = {
    args: {
...
//# sourceMappingURL=DownloadModal.stories.js.map